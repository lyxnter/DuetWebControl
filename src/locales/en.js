export default {
  global: {
    ...
    created: 'Created',
    uploaded: 'Uploaded',
    bigger_zero: 'Please, insert a value bigger than zero!',
  ...
  administration: {
    user: {
      users:   'Users',
      user:   'User',
      forgotpasswords:   'Forgot passwords',
      forgotpassword:   'Forgot password',
      connexionusers:   'User connexions',
      connexionuser:   'User connexion',
      ipadress: 'IP Adress',
      login: 'Login',
      email: 'Email',
      date: 'Date',
      ...
      passwordrequestedat: 'Last forgot password',
    },
